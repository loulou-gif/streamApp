        ...
        <section className='flex justify-center items-center h-[850px] mb-32 '>
            <div className='bg-white w-9/12 h-[750px]  '>
                <div className='search-ep flex items-center bg-slate-400 w-full h-16 p-5'>
                    ...
                    <select className='episode m-3 pl-5 w-[20rem] bg-gray-100 hover:bg-gray-200 duration-75 shadow-inner h-10  outline-none border-spacing-3'>
                ...
                <div  className='div-content mt-2 flex justify-center items-center w-full h-[622px]'><video controls poster={vignette} src={deo} playsinline className='video-content mt-5 bg-black w-[1450px] h-[622px]'></video></div>
