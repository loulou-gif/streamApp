    ...
    return (
        <section className='flex justify-center items-center h-[850px]  '>
            <div className='bg-white w-9/12 h-[695px]  '>
                ...
                <div  className='div-content flex justify-center items-center w-full h-[622px]'><video controls poster={detail.banner} src={detail.video}  className='video-content mt-5 bg-black w-[1450px] h-[621px]'></video></div>
