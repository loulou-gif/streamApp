    ...
    return (
        <section className='flex justify-center items-center h-[850px] mb-32 '>
            <div className='bg-white w-9/12 h-[750px]  '>
                ...
                <div  className='div-content mt-2 flex justify-center items-center w-full h-[622px]'><video controls poster={vignette} src={deo} playsinline className='video-content mt-5 bg-black w-[1450px] h-[621px]'></video></div>
