    ...
    return (
        <section className='a-la-une  flex justify-evenly items-end h-full '>
            <div className=' w-8/12  h-[450px] rounded-xl'>
                <Slider {...settings} >
                    {posters.map((poster) => (
                        <div key={poster.id} className="hover:shadow-1xl m-5 w-[800px] h-[430px] rounded-xl">
                            ...
                            <div className="">
                                <div className="flex justify-center items-center w-11/12 h-[430px]   " style={{
                                    ...
                                    <div className='text-left text-white w-9/12 '>
                                        <h1 className='text-3xl font-bold text-white text-left ' >{poster.name}</h1>
                                        <p className='text-2xl '>{poster.description}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
