        ...
        <div className='flex justify-center items-center pt-10  w-2/5'>
            <div className='form flex items-center h-[605px]  flex-col'>
                ...
                <h3>Déjà un compte?<Link to='/connexion' className='link'> Se connecter</Link> </h3>
                    <input type='text' name='username' className='mt-5 pl-5 p-2 h-[60px] rounded-xl' placeholder="Nom d'utilisateur"/>
                    <input type='email' name='email' className='mt-5 mb-5 pl-5 p-2 h-[60px] rounded-xl' placeholder="Email"/>
                    <input type='password' className='h-[60px] w-[342]  mb-5 pl-5 p-2 rounded-xl' placeholder='Mot de passe'/>
                    <button className='boutton bg-blue-700 text-white h-[60px] rounded-xl w-[342] ' >S'inscrire</button>
                </form>
            </div>
        </div>
    </section>
