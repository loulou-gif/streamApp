...
const Inscription = () => {
    return (
        ...
        <div className='flex justify-center items-center pt- border  w-2/5'>
            <div className='form flex items-center h-[605px]  flex-col'>
                ...
                <h3>Déjà un compte?<Link to='/connexion' className='link'> Se connecter</Link> </h3>
                    <input type='text' name='username' className='mt-5 pl-5 h-[60px] p-2 rounded-xl' placeholder="Nom d'utilisateur"/>
                    <input type='email' name='email' className='mt-5 mb-5 h-[60px] pl-5 p-2 rounded-xl' placeholder="Email"/>
                    <input type='password' className=' h-[60px] w-[342]  mb-5 pl-5 p-2 rounded-xl' placeholder='Mot de passe'/>
                    <button className='boutton bg-blue-700 text-white rounded-xl h-[60px] w-[342] ' >S'inscrire</button>
                </form>
            </div>
        </div>
    </section>
